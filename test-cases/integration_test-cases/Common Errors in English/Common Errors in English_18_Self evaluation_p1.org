...
* Test Steps
  ...
  3. Choose 'Rewriting omitted prepositions' option and click on the respective 'Exercise' link
  4. Don't enter the answer in the corresponding field and click on the 'correct answer' button

* Expected result
  1. Self evaluation page should be opened
  2. Content should be present with no distortions and Junk characters
  3. It should redirect to the Rewriting omitted prepositions page 
