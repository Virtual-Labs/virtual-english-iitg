...
* Test Steps
  ...
  3. Select '' Finding the error and re-writing a sentence "option and click on the respective 'Exercise' link
  4. Select the appropriate answers for one question and click on the appropriate radio buttton and then click on the 'check' button
