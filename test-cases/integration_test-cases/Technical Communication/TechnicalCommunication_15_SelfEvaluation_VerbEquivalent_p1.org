...
Objective
	...
	To view and take the Verb Equivalent quiz for Self Evaluation one by one 
...
Expected Result
	...
	2. The questions of the Verb Equivalent quiz should be opened in a particular sequence, one after another
