...
Objective
	...
	To view and take Verb Equivalent quiz for Self Evaluation and taking hint for the answer without entering any guess 
...
Expected Result
	...
	2. If the Verb Equivalent is not entered a dialog box should be displayed with the hint for correct letter and click on the OK button to make it disappear.
