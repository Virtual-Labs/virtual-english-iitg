...
*Pre conditions
    ...
    3.Select Virtual English and Communication Lab and click on Business Communication link, where select procedure tab on the screen
...
*Test Steps
    ...
    1.Click on Procedure link
    2.It should re-direct to the procedure page

*Expected result

    1. Procedure page should be open 
