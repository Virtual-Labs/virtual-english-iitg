...
I[0][2] = '1';
I[0][3] = new Array();
I[0][3][0] = new Array('Someone is knocking at the door.', '', 1, 100, 1);
I[1] = new Array();
I[1][0] = 100;
I[1][1] = '';
I[1][2] = '1';
I[1][3] = new Array();
I[1][3][0] = new Array('He came and asked for my pencil.', '', 1, 100, 1);
I[2] = new Array();
I[2][0] = 100;
I[2][1] = '';
I[2][2] = '1';
I[2][3] = new Array();
I[2][3][0] = new Array("She said to me, 'Come again.'", '', 1, 100, 1);
I[3] = new Array();
I[3][0] = 100;
I[3][1] = '';
I[3][2] = '1';
I[3][3] = new Array();
I[3][3][0] = new Array('They are searching for the missing ship.', '', 1, 100, 1);
I[4] = new Array();
I[4][0] = 100;
I[4][1] = '';
I[4][2] = '1';
I[4][3] = new Array();
I[4][3][0] = new Array('I am listening to music.', '', 1, 100, 1);
I[5] = new Array();
I[5][0] = 100;
I[5][1] = '';
I[5][2] = '1';
I[5][3] = new Array();
I[5][3][0] = new Array('We are going to Guwahati next week.', '', 1, 100, 1);
I[6] = new Array();
I[6][0] = 100;
I[6][1] = '';
I[6][2] = '1';
I[6][3] = new Array();
I[6][3][0] = new Array("He doesn't wish for anything better.", '', 1, 100, 1);
I[7] = new Array();
I[7][0] = 100;
I[7][1] = '';
I[7][2] = '1';
I[7][3] = new Array();
I[7][3][0] = new Array('Dad wrote to me today.', '', 1, 100, 1);
I[8] = new Array();
I[8][0] = 100;
I[8][1] = '';
I[8][2] = '1';
I[8][3] = new Array();
I[8][3][0] = new Array('Think of a colour and tell me.', '', 1, 100, 1);
I[9] = new Array();
I[9][0] = 100;
I[9][1] = '';
I[9][2] = '1';
I[9][3] = new Array();
I[9][3][0] = new Array('Remind me of that tomorrow.', '', 1, 100, 1);
...
function CheckGuess_DoCheck() {
    ...
    if (TrimString(this.WrongMiddle).length < 1) {
        this.WrongMiddle = '_';
    }
...
function CheckShortAnswer(QNum) {
    ...
    if ((State[QNum].length < 1) || (Finished == true)) {
        return;
    }
    ...
    if (CA.Feedback.length < 1) {
        CA.Feedback = DefaultWrong;
    }
